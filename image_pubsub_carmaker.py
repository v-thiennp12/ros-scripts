...
def main(args):
    ...
    tricam_long = image_feature("/camera/cam0/compressed", "images/cam0")
    #tricam_mid = image_feature("/camera/cam1/compressed", "images/cam1")
    #tricam_short = image_feature("/camera/cam2/compressed", "images/cam2")
